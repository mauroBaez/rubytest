                ...
                <tr>
                    <td align="center" valign="top" style="padding: 15px 0;" class="logo">
                        <a href="http://litmus.com" target="_blank">
                            <img alt="Logo" src="' + ActionController::Base.helpers.asset_url("logo.png") +'" width="220" height="220" style="display: block; font-family: 
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              	<td class="padding" align="center">
                                    <a href="http://litmus.com" target="_blank">
                                        <img src="' + ActionController::Base.helpers.asset_url("fondo-sm.jpg") +'" width="500" height="400" border="0" 
