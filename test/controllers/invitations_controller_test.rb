...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { sent: @invitation.sent, sent_datetime: @invitation.sent_datetime, title: @invitation.title } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { sent: @invitation.sent, sent_datetime: @invitation.sent_datetime, title: @invitation.title } }
